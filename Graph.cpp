...
void Polygon_BS ::draw_lines() const
{
...
void Rectangle_BS::draw_lines() const
{
...
void Ellipse_BS::draw_lines() const
{
	if (fill_color().visibility()) {	// fill
		fl_color(fill_color().as_int());
...
// {
	// //Ellipse_BS::draw_lines();
	// if (fill_color().visibility()) {	// fill
		// fl_color(fill_color().as_int());
		// cout << "Enter the starting angle of the arch:";
		// int amin;
		// cin >> amin;
		// cout << "Enter the end angle of the arch:";
		// int amaj;
		// cin >> amaj;
		// fl_pie(point(0).x, point(0).y, major() + major() - 1, minor() + minor() - 1, amin, amaj);
		// fl_color(color().as_int());	// reset color
	// }
	...
	// if (color().visibility()) {
		...
		// int amaj;
		// cin >> amaj;
		// fl_arc(point(0).x, point(0).y, major() + major(), minor() + minor(), amin, amaj);
	// }
// }
